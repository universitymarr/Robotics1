%% spline plot in case we have initial and final velocity are non zero
...
%% %% if v1=(q2-q1)/(t2-t1) and v4=(q4-q3)/(t4-t3)
a1=q2-q1; a2=(q2-q1)-v2*(t2-t1); a3= v2*(t2-t1)-(q2-q1);
b1=v2*(t3-t2); b2=3*(q3-q2)-(2*v2+v3)*(t3-t2); b3= -2*(q3-q2)+(v2+v3)*(t3-t2);
c1=v3*(t4-t3); c2=2*(q4-q3)-2*v3*(t4-t3); c3=v3*(t4-t3)-(q4-q3);
...
% matrix b
b=[(6*(q3-q2)*(t2-t1))/(t3-t2) + (4*(q2-q1)*(t3-t2))/(t2-t1);
    (6*(q3-q2)*(t4-t3))/(t3-t2) + (4*(q4-q3)*(t3-t2))/(t4-t3)]
